          ...
          <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,500px)_minmax(0,1fr)] lg:items-center lg:gap-12">
            ...
            <RevealOnView variant="slide-left" delayMs={60}>
              ...
              >
                ...
                <div className="mt-5 mx-auto aspect-[9/16] w-full max-w-[min(100%,340px)] overflow-hidden rounded-2xl border border-[#E86B00]/15 bg-[radial-gradient(ellipse_at_20%_20%,rgba(232,107,0,0.14),transparent_55%),#0a0f1e]">
